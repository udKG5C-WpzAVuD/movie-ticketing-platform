...
//                        只是生成movie相关文件 真的只是生成movies相关文件
                        builder.addInclude("admin_movie_operation_logs") // 设置需要生成的表名
//                                我又来了，来生成halls啦
//                                还有sessions表
//                                还有seats
//                                .addTablePrefix("t_") // 设置过滤表前缀
                                .entityBuilder()//enableFileOverride()// entity存在及覆盖  我只是不想让她覆盖而已
